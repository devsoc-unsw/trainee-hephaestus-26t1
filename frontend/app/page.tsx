    ...
    <div
      ...
      <main className="flex-1 px-6">
        ...
        <section className="max-w-6xl mx-auto">
          <h2 className="text-3xl mb-6">Work Mindfully.</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1: Timer*/}
            <Card
              className="bg-black/20 border-white/10 backdrop-blur-md shadow-2xl shadow-purple-950/10 transition-all duration-300 hover:border-purple-500/30 hover:bg-black/30 hover:-translate-y-1">
              <CardHeader>
                {/* Icon */}
