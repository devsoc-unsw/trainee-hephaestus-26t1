  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button>Term {currTerm}</Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent>
         <DropdownMenuGroup>
          <DropdownMenuItem onClick={() => setCurrTerm("26T1")}>Term 1</DropdownMenuItem>
          <DropdownMenuItem onClick={() => setCurrTerm("26T2")}>Term 2</DropdownMenuItem>
          <DropdownMenuItem onClick={() => setCurrTerm("26T3")}>Term 3</DropdownMenuItem>
         </DropdownMenuGroup>
      </DropdownMenuContent>
    </DropdownMenu>
  )
